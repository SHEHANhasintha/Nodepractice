   ...
   req.on('end', function(data){
     ...
     try{
       requestHandle(data,function(statusCode,payload,contentType){
          server.processResponce(statusCode,payload,contentType,res,method,path);
       });
     }catch(e){
        debug(e);
        server.processResponce(500,{'error' : 'unknown has been occured!'},'json',res,method);
     }
   });

 }

 server.processResponce = function(statusCode,payload,contentType,res,method,path){
