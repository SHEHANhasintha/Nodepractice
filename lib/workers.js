...
workers.validateChecks = function(orgData,callback){
  ...
  originalData.phone = typeof(orgData.phoneNumber) == 'number' &&  orgData.phoneNumber.toString().trim().length == 10 ? orgData.phoneNumber : false;
  ...
  originalData.timeoutseconds = typeof(orgData.timeoutseconds) == 'number' && orgData.timeoutseconds < 5 && orgData.timeoutseconds > 0 ? orgData.timeoutseconds : false;
