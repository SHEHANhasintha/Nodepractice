...
workers.validateChecks = function(orgData,callback){
  ...
  originalData.phone = typeof(parseInt(orgData.phoneNumber)) == 'number' &&  orgData.phoneNumber.toString().trim().length >= 10 ? parseInt(orgData.phoneNumber) : false;
  ...
  //console.log(originalData.id,originalData.phone,originalData.protocol,originalData.successCodes,originalData.url,originalData.method,originalData.timeoutseconds)
  //if those right
